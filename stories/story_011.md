...
## Acceptance Criteria
- [ ] A Service Worker caches the essential static files (HTML, CSS, JS, icon).
- [ ] If the user loses connection or explicitly sets their device to offline mode, opening the browser bookmark/site still loads the calculator properly.
- [ ] (Optional) A `manifest.json` allows the user to "Install to Home Screen" for an app-like experience.
