...
## Acceptance Criteria
- [ ] The materials list is visually separated from the input section (either below it or fixed at the footer).
- [ ] The quantities are displayed with the proper commercial units:
...
- [ ] Whenever `calculateAndRender()` is triggered due to an input change, the DOM is updated efficiently to display these new numbers without page reloading.
