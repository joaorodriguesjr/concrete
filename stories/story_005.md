...
## Acceptance Criteria
- [ ] The system provides a numeric input field dedicated to "Waste Margin (%)".
- [ ] The default value for the Waste Margin is set to 10%.
- [ ] The value is applied as a multiplier at the end of the total volume calculation (`VDP = VD + (VD * Margin%)`).
- [ ] The system requires the margin to be strictly between 5% and 20%.
- [ ] Inputs outside the 5% - 20% range must trigger a clear visual validation error to the user, blocking calculations from using invalid extremes.
